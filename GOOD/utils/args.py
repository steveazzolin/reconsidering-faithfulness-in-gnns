...
class CommonArgs(Tap):
    ...
    task: Literal['train', 'test', 'eval_metric', 'plot_sampling'] = None  #: Running mode. Allowed: 'train' and 'test'.
    random_seed: int = None  #: Fixed random seed for reproducibility.
    exp_round: int = None  #: Current experiment round.

    seeds: str = None 
    mitigation_backbone: str = None 
    mitigation_sampling: str = "feat" 
    mitigation_readout: str = None 
    mitigation_expl_scores: str = "default" 
    mitigation_expl_scores_topk: float = -1 
    expval_budget: int = None 
    numsamples_budget: int = None 
    fidelity_alpha_2: float = None 
    nec_alpha_1: float = None 
    feat_int_alpha: float = None 
    average_edge_attn: str = "default" 
    save_metrics: bool = False 
    intervention_distrib:str = "model_dependent" 
    acc_givenR: bool = False 
    mask: bool = False  
    metrics:str = "" 
    debias:bool = False 
    nec_marg_alpha:bool = True 
    samplingtype:str = "deconfounded" 
    nec_number_samples:str = "prop_G_dataset" 
    log_id: str = "" 
    splits: str = "" 
    ratios: str = "" 
